...
router.get('/:parentExpenseID', (req, res) => {
  ...
  paymentServer.getAllPaymentsByGroupExpense(req.params.parentExpenseID).then((payment: any) => {
      res.json(payment);
    })
    .catch((err: any) => {
      res.json(err);
...
router.get('/pending/:parentExpenseID', (req, res) => {
  ...
  paymentServer.getAllPendingPaymentsByGroupExpense(req.params.parentExpenseID).then((payment: any) => {
      res.json(payment);
    })
    .catch((err: any) => {
      res.json(err);
...
router.get('/paid/:parentExpenseID', (req, res) => {
  ...
  paymentServer.getAllPaidPaymentsByGroupExpense(req.params.parentExpenseID).then((payment: any) => {
      res.json(payment);
    })
    .catch((err: any) => {
      res.json(err);
...
router.get('/settled/:parentExpenseID', (req, res) => {
  ...
  paymentServer.getAllSettledPaymentsByGroupExpense(req.params.parentExpenseID).then((payment: any) => {
      res.json(payment);
    })
    .catch((err: any) => {
      res.json(err);
...
router.get('/:groupID/received/:receiverID', (req, res) => {
  ...
  paymentServer.getAllPaymentsToUserInGroup(req.params.groupID, req.params.receiverID).then((payment: any) => {
      res.json(payment);
    })
    .catch((err: any) => {
      res.json(err);
...
router.get('/:groupID/sent/:senderID', (req, res) => {
  ...
  paymentServer.getAllPaymentsFromUserInGroup(req.params.groupID, req.params.senderID).then((payment: any) => {
      res.json(payment);
    })
    .catch((err: any) => {
      res.json(err);
